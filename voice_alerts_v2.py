"""
VOICE ALERT SYSTEM (pyttsx3 version)
...
class VoiceAlertSystem:
    """TTS notifications for mission events using pyttsx3."""
    ...
    def notify_spawn_agent(self, agent_type: str):
        """Notify about new agent spawn."""
        msg = f"Spawned {agent_type} agent"
        self.queue_message(msg)
